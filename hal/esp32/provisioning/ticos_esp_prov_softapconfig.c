...
static const char *TAG = "ticos_esp_prov_softapconfig";
...
esp_err_t ticos_esp_prov_softapconfig_start(softapconfig_type_t type,
        const char *ssid, const char *password)
{
    ...
    if ((SOFTAPCONFIG_TYPE_ESPRESSIF & type) || (SOFTAPCONFIG_TYPE_ESPRESSIF_TENCENT & type)) {
         ...
         */
        wifi_prov_mgr_endpoint_register("custom-data", ticos_esp_prov_data_handler, NULL);
    }
...
esp_err_t ticos_esp_prov_softapconfig_stop()
{
    wifi_prov_mgr_deinit();
    ticos_esp_prov_udp_server_stop();
