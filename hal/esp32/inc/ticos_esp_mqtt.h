 ...
 */
typedef void (*ticos_esp_mqtt_subscribe_cb_t)(const char *topic, void *payload, size_t payload_len, void *priv_data);
 ...
 */
esp_err_t ticos_esp_mqtt_init(ticos_esp_mqtt_config_t *config);
 ...
 * @return error in case of any error.
 */
esp_err_t ticos_esp_mqtt_connect(void);
 ...
 * @return error in case of any error.
 */
esp_err_t ticos_esp_mqtt_disconnect(void);
 ...
 * @return error in case of any error.
 */
esp_err_t ticos_esp_mqtt_publish(const char *topic, void *data, size_t data_len);
 ...
 * @return error in case of any error.
 */
esp_err_t ticos_esp_mqtt_subscribe(const char *topic, ticos_esp_mqtt_subscribe_cb_t cb, void *priv_data);
 ...
 * @return error in case of any error.
 */
esp_err_t ticos_esp_mqtt_unsubscribe(const char *topic);
