 ...
 *     - others: fail
 */
esp_err_t ticos_esp_wifi_init(void);
 ...
 *     - others: fail
 */
esp_err_t ticos_esp_wifi_start(const wifi_config_t *sta_cfg);
 ...
 * @return esp_err_t 
 */
esp_err_t ticos_esp_wifi_reset(void);
 ...
 *     - others: fail
 */
esp_err_t ticos_esp_prov_smartconfig_start(smartconfig_type_t type);
 ...
 *     - others: fail
 */
esp_err_t ticos_esp_prov_smartconfig_stop(void);
 ...
 *     - others: fail
 */
esp_err_t ticos_esp_prov_softapconfig_start(softapconfig_type_t type, const char *ssid, const char *password);
 ...
 *     - others: fail
 */
esp_err_t ticos_esp_prov_softapconfig_stop(void);
