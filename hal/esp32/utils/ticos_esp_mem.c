...
typedef struct {
    ...
    int line;
    uint32_t timestamp;
} ticos_esp_mem_info_t;

static const char *TAG            = "ticos_esp_mem";
static uint32_t g_mem_count       = 0;
static ticos_esp_mem_info_t *g_mem_info = NULL;
