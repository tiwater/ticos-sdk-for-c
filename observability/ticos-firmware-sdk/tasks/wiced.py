...
WICED_ROOT = os.path.join(TICOS_SDK_ROOT, "examples", "wiced")
WICED_DEMO_APP_ROOT = os.path.join(WICED_ROOT, "ticos_demo_app")
...
DEMO_APP_TARGET = "ticos_demo_app-BCM943364WCD1-SDIO-debug"
