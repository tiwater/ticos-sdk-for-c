...
NRF_ROOT = os.path.join(TICOS_SDK_ROOT, "examples", "nrf5")
NRF_SDK_ROOT = os.path.join(NRF_ROOT, "nrf5_sdk")
NRF_DEMO_APP_ROOT = os.path.join(NRF_ROOT, "apps", "ticos_demo_app")
NRF_DEMO_APP_ELF = os.path.join(NRF_DEMO_APP_ROOT, "build", "ticos_demo_app_nrf52840_s140.out")
