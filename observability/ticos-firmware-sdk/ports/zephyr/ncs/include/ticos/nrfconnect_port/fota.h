...
//!
//! Integrates the Ticos Release Management Infrastructure with the FOTA Client in the nRF
//! Connect SDK
...
//! CONFIG_TICOS_FOTA_DOWNLOAD_CALLBACK_CUSTOM=y and implementing this function
