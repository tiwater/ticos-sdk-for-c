...
#
# ticos/core/compact_log_helpers.h makes use of the gnu expansion rules for ,## __VA_ARGS__. We
# explicitly opt in unit tests that need this feature with different gnu standard args for these
# tests
ifeq (,$(findstring TICOS_COMPACT_LOG_ENABLE=1,$(CPPUTEST_CPPFLAGS)))
...
TICOS_RESULT_DIR=$(BUILD_DIR)/$(COMPONENT_NAME)

export TEST_TARGET=$(TICOS_RESULT_DIR)/$(COMPONENT_NAME)_tests
export CPPUTEST_OBJS_DIR=$(TICOS_RESULT_DIR)/objs
export CPPUTEST_LIB_DIR=$(TICOS_RESULT_DIR)/lib
