...
void fake_ticos_event_storage_clear(void) {
  s_event_storage_state.curr_offset = 0;
  s_event_storage_state.space_available = s_event_storage_state.total_size;
}

void fake_ticos_event_storage_set_available_space(size_t space_available) {
...
const sTicosEventStorageImpl *ticos_events_storage_boot(void *buf, size_t buf_len) {
  ...
  static const sTicosEventStorageImpl s_fake_storage_impl = {
