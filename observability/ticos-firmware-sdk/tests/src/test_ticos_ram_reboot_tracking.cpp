...
TEST(MfltStorageTestGroup, Test_SetAndGetCrashInfo) {
  ...
  const eTicosRebootReason reason = kMfltRebootReason_Assert;
...
TEST(MfltStorageTestGroup, Test_NoRamRegionIntialized) {
  ...
  ticos_reboot_tracking_mark_reset_imminent(kMfltRebootReason_Assert, NULL);
...
TEST(MfltStorageTestGroup, Test_CrashTracking) {
  ...
  ticos_reboot_tracking_mark_reset_imminent(kMfltRebootReason_UnknownError, NULL);
...
TEST(MfltStorageTestGroup, Test_RebootSequence) {
  ...
  ticos_reboot_tracking_mark_reset_imminent(kMfltRebootReason_SoftwareWatchdog, NULL);
  ticos_reboot_tracking_boot(s_tcs_reboot_tracking_region, NULL);
  ...
  ticos_reboot_tracking_mark_reset_imminent(kMfltRebootReason_FirmwareUpdate, NULL);
