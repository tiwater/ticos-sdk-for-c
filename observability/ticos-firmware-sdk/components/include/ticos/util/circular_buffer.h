...
//!   ticos_circular_buffer_get_read_size())
...
//!
//! @param ctx User defined context as passed into "ticos_circular_buffer_read_with_callback".
...
typedef bool (*TicosCircularBufferReadCallback)(void *ctx, size_t offset,
                                                   const void *buf, size_t buf_len);

//! Convenience wrapper around "ticos_circular_buffer_get_read_pointer", to directly access
