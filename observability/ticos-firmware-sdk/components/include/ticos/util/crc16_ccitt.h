...
#define TICOS_CRC16_CCITT_INITIAL_VALUE 0x0
...
//!
//! @param crc_initial_value Use TICOS_CRC16_CCITT_INITIAL_VALUE when computing a new checksum over
...
uint16_t ticos_crc16_ccitt_compute(
