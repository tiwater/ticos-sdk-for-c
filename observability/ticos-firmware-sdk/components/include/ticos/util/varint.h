...
#define TICOS_UINT32_MAX_VARINT_LENGTH 5
...
//!   hold the encoding. The maximum encoding length is TICOS_UINT32_MAX_VARINT_LENGTH
//! @return The number of bytes written into the buffer
size_t ticos_encode_varint_u32(uint32_t value, void *buf);
...
//! @param[out] buf The buffer to write the Varint encoding to. Needs to be appropriately sized to
//!   hold the encoding. The maximum encoding length is TICOS_UINT32_MAX_VARINT_LENGTH
size_t ticos_encode_varint_si32(int32_t value, void *buf);
