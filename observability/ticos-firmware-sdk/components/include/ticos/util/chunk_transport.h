...
//!
//! Some IOT topologies have an MTU sizes that are less than the size of a Ticos Event or
//! Coredump. In these situations, the Ticos SDK will chunk up the data to be shipped out over
//! the transport and reassembled in the Ticos backend. That is what this API implements.
//!
//! NOTE: Consumers of the Ticos library should never be including this header directly or
...
#define TICOS_MIN_CHUNK_BUF_LEN 9
