...
#define TICOS_ROOT_CERTS_DIGICERT_GLOBAL_ROOT_CA                    \
  "-----BEGIN CERTIFICATE-----\n"                                      \
...
#define TICOS_ROOT_CERTS_DIGICERT_GLOBAL_ROOT_G2                    \
  "-----BEGIN CERTIFICATE-----\n"                                      \
...
#define TICOS_ROOT_CERTS_BALTIMORE_CYBERTRUST_ROOT                  \
  "-----BEGIN CERTIFICATE-----\n"                                      \
...
#define TICOS_ROOT_CERTS_AMAZON_ROOT_CA1                            \
  "-----BEGIN CERTIFICATE-----\n"                                      \
...
extern const uint8_t g_ticos_cert_digicert_global_root_ca[];
extern const size_t g_ticos_cert_digicert_global_root_ca_len;
extern const uint8_t g_ticos_cert_digicert_global_root_g2[];
extern const size_t g_ticos_cert_digicert_global_root_g2_len;
extern const uint8_t g_ticos_cert_baltimore_cybertrust_root[];
extern const size_t g_ticos_cert_baltimore_cybertrust_root_len;
extern const uint8_t g_ticos_cert_amazon_root_ca1[];
extern const size_t g_ticos_cert_amazon_root_ca1_len;
