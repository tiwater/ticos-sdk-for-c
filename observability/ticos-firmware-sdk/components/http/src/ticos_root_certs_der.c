...
//!
//! @brief
//! Representation of Root Certs Ticos uses in DER format

#include "ticos/http/root_certs.h"

#include <stdint.h>

const uint8_t g_ticos_cert_digicert_global_root_ca[] = {
...
const uint8_t g_ticos_cert_digicert_global_root_g2[] = {
...
const uint8_t g_ticos_cert_baltimore_cybertrust_root[] = {
...
const uint8_t g_ticos_cert_amazon_root_ca1[] = {
...
const size_t g_ticos_cert_digicert_global_root_ca_len = sizeof(g_ticos_cert_digicert_global_root_ca);
const size_t g_ticos_cert_digicert_global_root_g2_len = sizeof(g_ticos_cert_digicert_global_root_g2);
const size_t g_ticos_cert_baltimore_cybertrust_root_len = sizeof(g_ticos_cert_baltimore_cybertrust_root);
const size_t g_ticos_cert_amazon_root_ca1_len = sizeof(g_ticos_cert_amazon_root_ca1);
