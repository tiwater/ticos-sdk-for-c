...
#if TICOS_CRC16_LOOKUP_TABLE_ENABLE
...
TICOS_STATIC_ASSERT(TICOS_ARRAY_SIZE(s_crc16_ccit_table) == 256, "Unexpected CRC lookup table size");
...
#endif /* TICOS_CRC16_LOOKUP_TABLE_ENABLE */
