...
/* Maximum uninitialized retained data required by the application.                                             */
/****************************************************************************************************************/
// Note: There's two possible allocations we need here for Ticos
// 1. TICOS_REBOOT_TRACKING_REGION_SIZE (64 bytes) - used to hold info about resets taking place
// 2. TICOS_PLATFORM_COREDUMP_STORAGE_RAM_SIZE if and only if TICOS_PLATFORM_COREDUMP_STORAGE_USE_RAM=1
