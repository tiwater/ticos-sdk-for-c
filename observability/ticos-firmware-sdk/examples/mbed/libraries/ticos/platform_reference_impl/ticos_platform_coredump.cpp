...
const sTcsCoredumpRegion *ticos_platform_coredump_get_regions(
  ...
  s_coredump_regions[1] = TICOS_COREDUMP_MEMORY_REGION_INIT(
      &__data_start__, data_length);
  s_coredump_regions[2] = TICOS_COREDUMP_MEMORY_REGION_INIT(
...
// invoked once a coredump has been successfully flushed to the Ticos cloud. Therefore, we use
