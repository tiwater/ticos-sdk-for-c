 ...
 * @file
 *
 * @brief Warnings configuration and common macros for Ticos SDK code.
 ...
 */
#ifdef _MSC_VER
#define TI_INLINE static __forceinline
#elif defined(__GNUC__) || defined(__clang__) // !_MSC_VER
#define TI_INLINE __attribute__((always_inline)) static inline
#else // !_MSC_VER !__GNUC__ !__clang__
#define TI_INLINE static inline
#endif // _MSC_VER

#if defined(__GNUC__) && __GNUC__ >= 7
#define _ti_FALLTHROUGH __attribute__((fallthrough))
#else // !__GNUC__ >= 7
#define _ti_FALLTHROUGH \
  do                    \
  {                     \
  } while (0)
#endif // __GNUC__ >= 7
 ...
 */
#ifdef _MSC_VER
#define TI_NODISCARD _Check_return_
#elif defined(__GNUC__) || defined(__clang__) // !_MSC_VER
#define TI_NODISCARD __attribute__((warn_unused_result))
#else // !_MSC_VER !__GNUC__ !__clang__
#define TI_NODISCARD
#endif // _MSC_VER

// Get the number of elements in an array
#define _ti_COUNTOF(array) (sizeof(array) / sizeof((array)[0]))
