 ...
 * @file
 *
 * @brief Configurable constants used by the Ticos SDK.
 *
 * @remarks Typically, these constants do not need to be modified but depending on how your
 * application uses an Ticos service, they can be adjusted.
 *
...
enum
{
  ...
  TI_HTTP_REQUEST_URL_BUFFER_SIZE = 2 * 1024,

  /// The maximum buffer size for an HTTP request body.
  TI_HTTP_REQUEST_BODY_BUFFER_SIZE = 1024,

  /// The maximum buffer size for a log message.
  TI_LOG_MESSAGE_BUFFER_SIZE = 1024,
};
